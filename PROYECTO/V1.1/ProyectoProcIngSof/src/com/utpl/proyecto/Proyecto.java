...
public class Proyecto implements Serializable {
    ...
    public Proyecto(Integer idProyecto, Personas aux2, Personas aux1, Personas director, Propuesta idPropuesta) {
    ...
    public Proyecto(Personas aux2, Personas aux1, Personas director, Propuesta idPropuesta) {
        this.aux2 = aux2;
        this.aux1 = aux1;
        this.director = director;
        this.idPropuesta = idPropuesta;
