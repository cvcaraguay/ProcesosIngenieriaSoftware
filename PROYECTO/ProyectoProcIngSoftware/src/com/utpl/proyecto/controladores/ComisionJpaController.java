...
import com.utpl.proyecto.controladores.exceptions.PreexistingEntityException;
...
public class ComisionJpaController implements Serializable {
    ...
    public void create(Comision comision) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            Propuesta idPropuesta = comision.getIdPropuesta();
            if (idPropuesta != null) {
                idPropuesta = em.getReference(idPropuesta.getClass(), idPropuesta.getIdPropuesta());
                comision.setIdPropuesta(idPropuesta);
            }
            ...
            em.persist(comision);
            if (idPropuesta != null) {
                idPropuesta.getComisionList().add(comision);
            ...
            if (findComision(comision.getIdComision()) != null) {
    ...
    public void edit(Comision comision) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            Propuesta idPropuestaOld = persistentComision.getIdPropuesta();
            Propuesta idPropuestaNew = comision.getIdPropuesta();
            ...
            if (idPropuestaNew != null) {
                ...
                comision.setIdPropuesta(idPropuestaNew);
            }
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Propuesta idPropuesta = comision.getIdPropuesta();
            if (idPropuesta != null) {
                idPropuesta.getComisionList().remove(comision);
                idPropuesta = em.merge(idPropuesta);
            }
            Personas idPersona2 = comision.getIdPersona2();
            if (idPersona2 != null) {
