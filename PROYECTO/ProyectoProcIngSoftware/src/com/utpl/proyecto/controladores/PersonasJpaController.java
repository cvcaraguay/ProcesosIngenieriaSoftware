    ...
    public void create(Personas personas) {
        ...
        try {
            ...
            for (Proyecto proyectoListProyecto : personas.getProyectoList()) {
                Personas oldDirectorOfProyectoListProyecto = proyectoListProyecto.getDirector();
                proyectoListProyecto.setDirector(personas);
            ...
            for (Proyecto proyectoList2Proyecto : personas.getProyectoList2()) {
                Personas oldAux2OfProyectoList2Proyecto = proyectoList2Proyecto.getAux2();
                proyectoList2Proyecto.setAux2(personas);
                proyectoList2Proyecto = em.merge(proyectoList2Proyecto);
                if (oldAux2OfProyectoList2Proyecto != null) {
                    oldAux2OfProyectoList2Proyecto.getProyectoList2().remove(proyectoList2Proyecto);
                    oldAux2OfProyectoList2Proyecto = em.merge(oldAux2OfProyectoList2Proyecto);
                }
            }
        ...
        try {
            ...
            for (Proyecto proyectoList2OldProyecto : proyectoList2Old) {
                if (!proyectoList2New.contains(proyectoList2OldProyecto)) {
                    ...
                    illegalOrphanMessages.add("You must retain Proyecto " + proyectoList2OldProyecto + " since its aux2 field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (Proyecto proyectoListNewProyecto : proyectoListNew) {
                if (!proyectoListOld.contains(proyectoListNewProyecto)) {
                    Personas oldDirectorOfProyectoListNewProyecto = proyectoListNewProyecto.getDirector();
                    proyectoListNewProyecto.setDirector(personas);
                    proyectoListNewProyecto = em.merge(proyectoListNewProyecto);
                    if (oldDirectorOfProyectoListNewProyecto != null && !oldDirectorOfProyectoListNewProyecto.equals(personas)) {
            ...
            for (Proyecto proyectoList2NewProyecto : proyectoList2New) {
                if (!proyectoList2Old.contains(proyectoList2NewProyecto)) {
                    Personas oldAux2OfProyectoList2NewProyecto = proyectoList2NewProyecto.getAux2();
                    proyectoList2NewProyecto.setAux2(personas);
                    proyectoList2NewProyecto = em.merge(proyectoList2NewProyecto);
                    if (oldAux2OfProyectoList2NewProyecto != null && !oldAux2OfProyectoList2NewProyecto.equals(personas)) {
                        oldAux2OfProyectoList2NewProyecto.getProyectoList2().remove(proyectoList2NewProyecto);
                        oldAux2OfProyectoList2NewProyecto = em.merge(oldAux2OfProyectoList2NewProyecto);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            for (Proyecto proyectoListOrphanCheckProyecto : proyectoListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Personas (" + personas + ") cannot be destroyed since the Proyecto " + proyectoListOrphanCheckProyecto + " in its proyectoList field has a non-nullable director field.");
            }
            ...
            for (Proyecto proyectoList2OrphanCheckProyecto : proyectoList2OrphanCheck) {
                ...
                illegalOrphanMessages.add("This Personas (" + personas + ") cannot be destroyed since the Proyecto " + proyectoList2OrphanCheckProyecto + " in its proyectoList2 field has a non-nullable aux2 field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
